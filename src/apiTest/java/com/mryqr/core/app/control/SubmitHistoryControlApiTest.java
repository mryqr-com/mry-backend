...
public class SubmitHistoryControlApiTest extends BaseApiTest {
    ...
    public void should_fetch_submit_history_presentation_value() {
        ...
        FDateTimeControl dateTimeControl = defaultDateTimeControlBuilder().fillableSetting(fillableSetting).build();
        ...
        TextDisplayValue dateTimeValue = (TextDisplayValue) valueMap.get(dateTimeControl.getId());
        assertEquals(dateTimeAnswer.toDateTimeString(), dateTimeValue.getText());
