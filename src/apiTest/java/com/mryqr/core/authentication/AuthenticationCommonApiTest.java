...
public class AuthenticationCommonApiTest extends BaseApiTest {
    ...
    public void should_fail_authentication_with_expired_jwt() {
        BaseApiTest.given("eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJNQlI5MzI1NTc4MDIyNTIwMTE1MiIsInJvbGUiOiJURU5BTlRfQURNSU4iLCJ0ZW5hbnQiOiJUTlQ5MzI1NTc4MDIyMTAwNjg0OCIsImlzcyI6Im1yeS1sb2NhbC1pc3N1ZXIiLCJpYXQiOjE2MDAwNzQzNzIsImV4cCI6MTYwMDA4MTU3Mn0.OWS9GefYwNnFY7lImxqpIFujDUNlmZkpHm9CMJ8v2T8YyByKulIpYjStt5IHqRZYaW6dek0GC7HcjZG-abykCQ")
                .when()
                .put("/refresh-token")
                .then()
                .statusCode(401);
    ...
    public void api_key_should_not_call_non_integration_controllers() {
        ...
        Tenant tenant = tenantRepository.byId(response.getTenantId());
        setupApi.updateTenantPackages(tenant, FLAGSHIP, now().plus(100 * 365, DAYS));
