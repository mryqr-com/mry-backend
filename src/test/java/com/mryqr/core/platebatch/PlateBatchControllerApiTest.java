...
class PlateBatchControllerApiTest extends BaseApiTest {
    ...
    public void should_create_plate_batch() {
        ...
        assertEquals(response.appId(), plateBatch.getAppId());
    ...
    public void should_fail_create_if_name_already_exists() {
        PreparedAppResponse response = setupApi.registerWithApp();
        CreatePlateBatchCommand command = CreatePlateBatchCommand.builder().appId(response.appId()).name(rPlateBatchName()).total(10).build();
        PlateBatchApi.createPlateBatch(response.jwt(), command);

        assertError(() -> PlateBatchApi.createPlateBatchRaw(response.jwt(), command), PLATE_BATCH_WITH_NAME_ALREADY_EXISTS);
    }
    ...
    public void should_rename_plate_batch() {
        ...
        PlateBatchApi.renamePlateBatch(response.jwt(), plateBatchId, newName);
    ...
    public void should_fail_rename_plate_batch_if_name_already_exist() {
        PreparedAppResponse response = setupApi.registerWithApp();
        String previousPlateBatchId = PlateBatchApi.createPlateBatch(response.jwt(), response.appId(), 10);
        String plateBatchId = PlateBatchApi.createPlateBatch(response.jwt(), response.appId(), 10);
        RenamePlateBatchCommand command = RenamePlateBatchCommand.builder().name(rPlateBatchName()).build();
        PlateBatchApi.renamePlateBatch(response.jwt(), previousPlateBatchId, command);

        assertError(() -> PlateBatchApi.renamePlateBatchRaw(response.jwt(), plateBatchId, command), PLATE_BATCH_WITH_NAME_ALREADY_EXISTS);
    }
    ...
    public void should_delete_plate_batch() {
        ...
        PlateBatchApi.deletePlateBatch(response.jwt(), plateBatchId);
    ...
    public void should_list_plate_batches() {
        PreparedAppResponse response = setupApi.registerWithApp();
        IntStream.range(0, 11).forEach(value -> PlateBatchApi.createPlateBatch(response.jwt(), response.appId(), 10));
        ...
        ListMyManagedPlateBatchesQuery query = ListMyManagedPlateBatchesQuery.builder()
                ...
                .pageSize(10)
                .build();
        PagedList<QManagedListPlateBatch> pagedList1 = PlateBatchApi.listPlateBatches(response.jwt(), query);
        ...
        ListMyManagedPlateBatchesQuery query2 = ListMyManagedPlateBatchesQuery.builder()
                ...
                .pageSize(10)
                .build();
        PagedList<QManagedListPlateBatch> pagedList2 = PlateBatchApi.listPlateBatches(response.jwt(), query2);
    ...
    public void should_search_plate_batches() {
        ...
        CreatePlateBatchCommand command = CreatePlateBatchCommand.builder().appId(response.appId()).name(name).total(10).build();
        String plateBatchId = PlateBatchApi.createPlateBatch(response.jwt(), command);
        PlateBatchApi.createPlateBatch(response.jwt(), response.appId(), 10);
        ...
        PagedList<QManagedListPlateBatch> pagedList = PlateBatchApi.listPlateBatches(response.jwt(), query);
    ...
    public void should_fetch_all_plate_ids_for_plate_batch() {
        ...
        List<String> plateIds = PlateBatchApi.allPlateIdsUnderPlateBatch(response.jwt(), plateBatchId);
    ...
    public void should_fetch_unused_plate_ids_for_plate_batch() {
        ...
        List<String> allPlateIds = PlateBatchApi.allPlateIdsUnderPlateBatch(response.jwt(), plateBatchId);
        assertEquals(10, allPlateIds.size());

        List<String> unusedPlateIds = PlateBatchApi.unusedPlateIdsUnderPlateBatch(response.jwt(), plateBatchId);
