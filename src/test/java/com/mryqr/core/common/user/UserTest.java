...
class UserTest extends BaseUnitTest {
    ...
    public void should_create_robot_user() {
        ...
        assertEquals(user.getTenantId(), tenantId);
        assertEquals(user.getRole(), TENANT_ADMIN);
        assertEquals(user.getChannel(), ROBOT);
    }

    @Test
    public void should_create_anonymous_human_user() {
        User user = ANONYMOUS_HUMAN_USER;
        assertNull(user.getMemberId());
        assertNull(user.getTenantId());
        assertNull(user.getRole());
        assertEquals(user.getChannel(), HUMAN);
    }
    ...
    public void should_logged_in_as_anonymous() {
        ...
        assertEquals(HUMAN, user.getChannel());
