...
public class AssignmentPlanControllerApiTest extends BaseApiTest {
    ...
    public void should_fail_create_if_name_duplicates() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.getJwt(),
    ...
    public void should_update_assignment_plan_setting() {
        ...
        AssignmentPlanApi.updateAssignmentPlanSetting(response.getJwt(), assignmentPlanId,
    ...
    public void update_assignment_plan_setting_should_do_validation() {
        ...
        assertError(() -> AssignmentPlanApi.updateAssignmentPlanSettingRaw(response.getJwt(), assignmentPlanId,
    ...
    public void should_fail_exclude_group_if_not_all_groups_exists() {
        ...
        assertError(() -> AssignmentPlanApi.excludeGroupsRaw(response.getJwt(), assignmentPlanId,
    ...
    public void should_fail_set_group_operators_if_not_all_members_exist() {
        ...
        assertError(() -> AssignmentPlanApi.setGroupOperatorsRaw(response.getJwt(), assignmentPlanId, setGroupOperatorsCommand),
    ...
    public void should_list_assignment_plans() {
        ...
        String assignmentPlanId1 = AssignmentPlanApi.createAssignmentPlan(response.getJwt(),
                CreateAssignmentPlanCommand.builder().setting(AssignmentSetting.builder()
                        ...
                        .build()).build());
        List<String> excludedGroups = List.of(response.getDefaultGroupId());
        AssignmentPlanApi.excludeGroups(response.getJwt(), assignmentPlanId1,
                ExcludeGroupsCommand.builder().excludedGroups(excludedGroups).build());

        String assignmentPlanId2 = AssignmentPlanApi.createAssignmentPlan(response.getJwt(),
                CreateAssignmentPlanCommand.builder().setting(AssignmentSetting.builder()
                        .name(rAssignmentPlanName())
                        .appId(response.getAppId())
                        .pageId(response.getHomePageId())
    ...
    public void should_list_assignment_plan_summaries() {
        ...
        String assignmentPlanId3 = AssignmentPlanApi.createAssignmentPlan(response.getJwt(),
                CreateAssignmentPlanCommand.builder().setting(AssignmentSetting.builder()
                        .name(rAssignmentPlanName())
                        .appId(response.getAppId())
                        .pageId(response.getHomePageId())
    ...
    public void should_list_assignment_plan_summaries_for_group() {
        ...
        AssignmentPlanApi.deactivateAssignmentPlan(response.getJwt(), assignmentPlanId1);
        AssignmentPlanApi.excludeGroups(response.getJwt(), assignmentPlanId2,
                ExcludeGroupsCommand.builder().excludedGroups(List.of(response.getDefaultGroupId())).build());

        List<QAssignmentPlanSummary> summaries = AssignmentPlanApi.listAssignmentPlanSummariesForGroup(response.getJwt(),
                response.getDefaultGroupId());
