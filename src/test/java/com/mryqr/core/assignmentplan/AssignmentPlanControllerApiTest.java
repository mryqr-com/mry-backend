...
public class AssignmentPlanControllerApiTest extends BaseApiTest {
    ...
    public void should_fail_create_if_name_duplicates() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), ASSIGNMENT_PLAN_WITH_NAME_ALREADY_EXISTS);
    }
    ...
    public void should_fail_create_if_assignment_not_enabled() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), APP_ASSIGNMENT_NOT_ENABLED);
    }
    ...
    public void should_fail_create_if_packages_too_low() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), ASSIGNMENT_NOT_ALLOWED);
    }
    ...
    public void should_fail_create_if_page_not_found() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), PAGE_NOT_FOUND);
    }
    ...
    public void should_fail_create_if_start_time_after_end_time() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), ASSIGNMENT_START_TIME_AFTER_END_TIME);
    }
    ...
    public void should_fail_create_if_time_duration_exceed_frequency() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), ASSIGNMENT_DURATION_EXCEED_FREQUENCY);
    }
    ...
    public void should_fail_create_if_time_near_end_notify_overflow() {
        ...
        assertError(() -> AssignmentPlanApi.createAssignmentPlanRaw(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(assignmentSetting).build()), ASSIGNMENT_NOTIFY_TIME_OVERFLOW);
    }
    ...
    public void should_update_assignment_plan_setting() {
        ...
        AssignmentPlanApi.updateAssignmentPlanSetting(response.jwt(), assignmentPlanId,
                UpdateAssignmentPlanSettingCommand.builder().setting(updateAssignmentSetting).build());
    ...
    public void update_assignment_plan_setting_should_do_validation() {
        ...
        assertError(() -> AssignmentPlanApi.updateAssignmentPlanSettingRaw(response.jwt(), assignmentPlanId,
                UpdateAssignmentPlanSettingCommand.builder().setting(updateAssignmentSetting).build()), ASSIGNMENT_DURATION_EXCEED_FREQUENCY);
    }
    ...
    public void should_exclude_groups() {
        ...
        AssignmentPlanApi.excludeGroups(response.jwt(), assignmentPlanId,
                ExcludeGroupsCommand.builder().excludedGroups(excludedGroups).build());
    ...
    public void should_fail_exclude_group_if_not_all_groups_exists() {
        ...
        assertError(() -> AssignmentPlanApi.excludeGroupsRaw(response.jwt(), assignmentPlanId,
                ExcludeGroupsCommand.builder().excludedGroups(excludedGroups).build()), NOT_ALL_GROUPS_EXIST);
    }
    ...
    public void should_fail_set_group_operators_if_not_all_members_exist() {
        ...
        assertError(() -> AssignmentPlanApi.setGroupOperatorsRaw(response.jwt(), assignmentPlanId, setGroupOperatorsCommand),
                NOT_ALL_MEMBERS_EXIST);
    }
    ...
    public void should_list_assignment_plans() {
        ...
        String assignmentPlanId1 = AssignmentPlanApi.createAssignmentPlan(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(AssignmentSetting.builder()
                        ...
                        .build()).build());
        List<String> excludedGroups = List.of(response.defaultGroupId());
        AssignmentPlanApi.excludeGroups(response.jwt(), assignmentPlanId1,
                ExcludeGroupsCommand.builder().excludedGroups(excludedGroups).build());

        String assignmentPlanId2 = AssignmentPlanApi.createAssignmentPlan(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(AssignmentSetting.builder()
                        .name(rAssignmentPlanName())
                        .appId(response.appId())
                        .pageId(response.homePageId())
    ...
    public void should_list_assignment_plan_summaries() {
        ...
        String assignmentPlanId3 = AssignmentPlanApi.createAssignmentPlan(response.jwt(),
                CreateAssignmentPlanCommand.builder().setting(AssignmentSetting.builder()
                        .name(rAssignmentPlanName())
                        .appId(response.appId())
                        .pageId(response.homePageId())
    ...
    public void should_list_assignment_plan_summaries_for_group() {
        ...
        AssignmentPlanApi.deactivateAssignmentPlan(response.jwt(), assignmentPlanId1);
        AssignmentPlanApi.excludeGroups(response.jwt(), assignmentPlanId2,
                ExcludeGroupsCommand.builder().excludedGroups(List.of(response.defaultGroupId())).build());

        List<QAssignmentPlanSummary> summaries = AssignmentPlanApi.listAssignmentPlanSummariesForGroup(response.jwt(),
                response.defaultGroupId());
