...
import static com.mryqr.common.domain.stat.QrSegmentType.ATTRIBUTE_VALUE_MAX;
...
public class AppReportSettingApiTest extends BaseApiTest {
    ...
    public void should_update_chart_report() {
        ...
        List<ChartReport> reports = newArrayList(controlBarReport, controlPieReport, controlDoughnutReport, controlNumberRangeSegmentReport,
                controlTimeSegmentReport,
