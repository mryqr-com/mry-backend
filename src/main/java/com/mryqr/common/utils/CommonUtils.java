...
import static com.mryqr.common.utils.MryRegexConstants.MOBILE_USER_AGENT_PATTERN;
...
public class CommonUtils {
    ...
    private static final Pattern MOBILE_REQUEST_PATTERN = Pattern.compile(MOBILE_USER_AGENT_PATTERN, CASE_INSENSITIVE);
    ...
    public static boolean isMobileRequest(HttpServletRequest request) {
        ...
        return isNotBlank(userAgent) && MOBILE_REQUEST_PATTERN.matcher(userAgent).matches();
    }
