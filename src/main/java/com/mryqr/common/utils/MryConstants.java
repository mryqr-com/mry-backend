...
public class MryConstants {
    ...
    public static final DateTimeFormatter MRY_TIME_FORMATTER = ofPattern("HH:mm").withZone(systemDefault());
    ...
    public static final String IN_APP_NOTIFICATION_COLLECTION = "in_app_notification";
