...
import static com.mryqr.common.domain.user.UserChannel.ROBOT;
...
public final class User {
    public static final User NO_USER = new User(null, null, null, null, null);
    public static final User ANONYMOUS_HUMAN_USER = new User(null, null, null, null, HUMAN);
    ...
    private User(String memberId, String name, String tenantId, Role role, UserChannel channel) {
    ...
    public static User humanUser(String memberId, String name, String tenantId, Role role) {
        ...
        return new User(memberId, name, tenantId, role, HUMAN);
    }

    public static User robotUser(String tenantId) {
        requireNonBlank(tenantId, "TenantId must not be blank.");

        return new User(null, null, tenantId, TENANT_ADMIN, ROBOT);
    }
