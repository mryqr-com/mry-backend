...
public class MryTenantManageApp {
    ...
    public static final String RECENT_ACTIVE_DATE_CONTROL_ID = "c_tG2LSb2TMttdfXu79t2eBj";
    ...
    public static final String APP_LIST_CONTROL_ID = "c_dAoSFcQYRocLPBsZjDVMfu";
    ...
    public static final String ASSIGNMENT_ALLOWED_CONTROL_ID = "c_vq8TPmcXR4aWFT8gQnnZPi";
    public static final String ASSIGNMENT_ALLOWED_ACTIVATED_ID = "tNVJPZ2ix6DKKHagsPSEKL";
    public static final String ASSIGNMENT_ALLOWED_DEACTIVATED_ID = "wvECYJAP3aWgSxpKDacGz5";
    ...
    public static final String RECENT_ACTIVE_DATE_ATTR_ID = "a_bUWBC4y3KqSevbDFCsri74";
    ...
    public void init() {
        ...
        FDateTimeControl recentActiveDateControl = FDateTimeControl.builder()
                .type(DATE_TIME)
        ...
        FRichTextInputControl appListControl = FRichTextInputControl.builder()
                .type(RICH_TEXT_INPUT)
                .id(APP_LIST_CONTROL_ID)
                .name("应用列表")
                .nameSetting(defaultControlNameSetting())
                .descriptionStyle(defaultControlDescriptionStyle())
                .styleSetting(defaultControlStyleSetting())
        ...
        Page syncPage = Page.builder()
                ...
                .controls(List.of(currentPlanControl, expireDateControl, packagesStatusControl,
                        registerDateControl, recentActiveDateControl, activeStatusControl,
                        packageDescriptionControl, appListControl, appUsageControl,
                        qrUsageControl, submissionUsageControl, memberUsageControl,
                        storageUsageControl, smsUsageControl,
                        invoiceTitleControl, adminsControl, opsLogControl))
        ...
        FRadioControl assignmentAllowedControl = FRadioControl.builder()
                .type(RADIO)
                .id(ASSIGNMENT_ALLOWED_CONTROL_ID)
                .name("定期任务功能")
                .nameSetting(defaultControlNameSetting())
                .descriptionStyle(defaultControlDescriptionStyle())
                .styleSetting(defaultControlStyleSetting())
                ...
                .permission(CAN_MANAGE_APP)
                .options(List.of(
                        TextOption.builder().id(ASSIGNMENT_ALLOWED_ACTIVATED_ID).name("开启").build(),
                        TextOption.builder().id(ASSIGNMENT_ALLOWED_DEACTIVATED_ID).name("禁用").build()
                ))
                .build();
        ...
        AppSetting setting = AppSetting.builder()
                ...
                .pages(List.of(homePage, syncPage, communicationPage, statusSettingPage, packageSettingPage, limitSettingPage,
                        triggerSyncPage, clearCachePage, sendEventPage, resetMemberPasswordPage))
                .menu(menu)
