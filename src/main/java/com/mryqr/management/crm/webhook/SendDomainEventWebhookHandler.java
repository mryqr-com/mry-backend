...
import static com.mryqr.common.event.publish.PublishingDomainEvent.Fields.raisedAt;
...
public class SendDomainEventWebhookHandler implements TenantWebhookHandler {
    ...
    public void handle(BaseSubmissionWebhookPayload payload) {
        ...
        boolean isAllTenant =
                sendEventAllTenantAnswer != null && sendEventAllTenantAnswer.getOptionId().equals(SEND_EVENT_ALL_TENANT_YES_OPTION_ID);
