...
@JsonSubTypes(value = {
        ...
        @JsonSubTypes.Type(value = FDateTimeControl.class, name = "DATE_TIME"),
...
public abstract class Control implements Identified {
    ...
    protected void configMandatory(boolean value) {
        if (this.fillableSetting != null) {
    ...
    protected void configAutoFill(boolean value) {
        if (this.fillableSetting != null) {
