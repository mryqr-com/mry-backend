...
import static com.mryqr.common.domain.ValueType.LOCAL_DATE_VALUE;
import static com.mryqr.common.domain.ValueType.TIMESTAMP_VALUE;
...
public class AttributeTimeSegmentReportSetting implements AttributeAware {
    ...
    public static class TimeSegmentSetting implements Identified {
        ...
        @NotNull
        private QrTimeBasedType basedType;
