...
public class PageChangedToSubmitPerMemberEventHandler extends DomainEventHandler<AppPageChangedToSubmitPerMemberEvent> {
    ...
    @Override
    public void handle(AppPageChangedToSubmitPerMemberEvent event) {
