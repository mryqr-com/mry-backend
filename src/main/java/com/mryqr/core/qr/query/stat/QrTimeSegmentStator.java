...
import static com.mryqr.common.domain.stat.QrTimeBasedType.CREATED_AT;
...
public class QrTimeSegmentStator {
    private final MongoTemplate mongoTemplate;

    public List<TimeSegment> stat(Set<String> groupIds,
                                  QrSegmentType segmentType,
                                  QrTimeBasedType basedType,
    ...
    private AggregationParameters buildAggregationParameters(QrTimeBasedType basedType,
                                                             String basedAttributeId,
                                                             App app,
                                                             Criteria criteria,
                                                             Instant startAt) {
