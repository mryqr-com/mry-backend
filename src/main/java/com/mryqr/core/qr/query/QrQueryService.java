...
import com.mryqr.core.qr.domain.task.RecordQrAccessTask;
...
import static com.mryqr.common.utils.CommonUtils.isMobileRequest;
...
public class QrQueryService {
    ...
    private final RecordQrAccessTask recordQrAccessTask;
    ...
    public QSubmissionQr fetchSubmissionQr(String plateId, User user, HttpServletRequest request) {
        ...
        boolean isMobileRequest = isMobileRequest(request);
        taskExecutor.execute(() -> {
            recordQrAccessTask.run(qr, app, isMobileRequest);
