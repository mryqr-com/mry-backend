...
public class InstanceGroupManagersAndMobileCalculator implements AttributeValueCalculator {
    private final GroupRepository groupRepository;

    @Override
    public boolean canCalculate(Attribute attribute, App app) {
        return attribute.getType() == INSTANCE_GROUP_MANAGERS_AND_MOBILE;
    }
    ...
    public AttributeValue calculate(Attribute attribute, QR qr, App app) {
        ...
        return isNotEmpty(managerIds) ? new MembersMobileAttributeValue(attribute, managerIds) : null;
    }
}
