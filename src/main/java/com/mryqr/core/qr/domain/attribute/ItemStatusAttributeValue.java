...
@Getter
@TypeAlias("ITEM_STATUS_VALUE")
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor(access = PRIVATE)
public class ItemStatusAttributeValue extends AttributeValue {
    private String controlId;
    private String optionId;

    public ItemStatusAttributeValue(Attribute attribute, String controlId, String optionId) {
        super(attribute);
    ...
    public void clean(App app) {
        ...
        app.controlByIdOptional(controlId).ifPresent(control -> {
            Set<String> allOptionIds = ((FItemStatusControl) control).allOptionIds();
    ...
    protected String doGetExportValue(Attribute attribute, QrReferenceContext context, Control refControl) {
        FItemStatusControl theControl = (FItemStatusControl) refControl;
