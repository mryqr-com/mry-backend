...
@Getter
@TypeAlias("MULTI_LINE_TEXT_VALUE")
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor(access = PRIVATE)
public class MultiLineTextAttributeValue extends AttributeValue {
    private String content;

    public MultiLineTextAttributeValue(Attribute attribute, String content) {
        super(attribute);
