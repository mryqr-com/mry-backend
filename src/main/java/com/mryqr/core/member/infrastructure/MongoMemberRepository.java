...
import static com.mryqr.core.common.exception.ErrorCode.MEMBER_NOT_FOUND;
...
public class MongoMemberRepository extends MongoBaseRepository<Member> implements MemberRepository {
    ...
    public List<TenantCachedMember> cachedTenantAllMembers(String tenantId) {
        ...
        return cachedMemberRepository.cachedTenantAllMembers(tenantId);
    }
    ...
    public boolean cachedNotAllMembersExist(List<String> memberIds, String tenantId) {
        ...
        Set<String> allMemberIds = cachedMemberRepository.cachedTenantAllMembers(tenantId).stream()
    ...
    public int cachedActiveTenantAdminCountFor(String tenantId) {
        ...
        return (int) cachedMemberRepository.cachedTenantAllMembers(tenantId)
                .stream()
    ...
    public boolean cachedExistsByCustomId(String customId, String tenantId) {
        ...
        return cachedMemberRepository.cachedTenantAllMembers(tenantId).stream().anyMatch(member -> Objects.equals(member.getCustomId(), customId));
    }
