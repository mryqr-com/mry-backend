...
import com.mryqr.core.inappnotification.domain.task.RemoveAllInAppNotificationForMemberTask;
...
public class MemberDeletedEventHandler extends AbstractDomainEventHandler<MemberDeletedEvent> {
    ...
    private final RemoveAllInAppNotificationForMemberTask removeAllInAppNotificationForMemberTask;
    ...
    public void handle(MemberDeletedEvent event) {
        ...
        MryTaskRunner.run(() -> removeAllInAppNotificationForMemberTask.run(event.getMemberId()));
