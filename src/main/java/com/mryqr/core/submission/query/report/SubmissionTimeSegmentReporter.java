...
import com.mryqr.core.common.domain.report.SubmissionReportTimeBasedType;
...
public class SubmissionTimeSegmentReporter {
    private final MongoTemplate mongoTemplate;

    public List<TimeSegment> reportForQr(String qrId,
                                         SubmissionSegmentType segmentType,
                                         SubmissionReportTimeBasedType basedType,
                                         String pageId,
        ...
        return this.report(qrId, null, segmentType, basedType, pageId, basedControlId, targetControlId, interval, max, app);
    }

    public List<TimeSegment> reportForGroups(Set<String> groupIds,
                                             SubmissionSegmentType segmentType,
                                             SubmissionReportTimeBasedType basedType,
                                             String pageId,
                                             String basedControlId,
        ...
        return this.report(null, groupIds, segmentType, basedType, pageId, basedControlId, targetControlId, interval, max, app);
    }

    private List<TimeSegment> report(String qrId,
                                     Set<String> groupIds,
                                     SubmissionSegmentType segmentType,
                                     SubmissionReportTimeBasedType basedType,
                                     String pageId,
    ...
    private AggregationParameters buildAggregationParameters(SubmissionReportTimeBasedType basedType,
                                                             String pageId,
                                                             String basedControlId,
                                                             App app,
                                                             Criteria criteria,
