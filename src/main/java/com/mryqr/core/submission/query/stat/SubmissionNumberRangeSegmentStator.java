...
public class SubmissionNumberRangeSegmentStator {
    ...
    public List<NumberRangeSegment> statForQr(String qrId,
        ...
        return this.stat(qrId, null, segmentType, pageId, basedControlId, targetControlId, range, segments, app);
    }

    public List<NumberRangeSegment> statForGroups(Set<String> groupIds,
                                                  SubmissionSegmentType segmentType,
                                                  String pageId,
                                                  String basedControlId,
                                                  String targetControlId,
        ...
        requireNonNull(segments, "Segments must not be null.");
        requireNonNull(app, "App must not be null.");
        return this.stat(null, groupIds, segmentType, pageId, basedControlId, targetControlId, range, segments, app);
    }

    private List<NumberRangeSegment> stat(String qrId,
                                          Set<String> groupIds,
                                          SubmissionSegmentType segmentType,
                                          String pageId,
                                          String basedControlId,
