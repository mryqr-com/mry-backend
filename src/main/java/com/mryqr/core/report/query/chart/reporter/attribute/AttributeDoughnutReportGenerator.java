...
public class AttributeDoughnutReportGenerator implements ChartReportGenerator {
    ...
    public boolean supports(ChartReport report) {
        return report instanceof AttributeDoughnutReport;
    }

    @Override
    public QChartReport generate(ChartReport report, Set<String> groupIds, App app) {
        AttributeDoughnutReport theReport = (AttributeDoughnutReport) report;
