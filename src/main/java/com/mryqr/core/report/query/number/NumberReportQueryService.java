...
public class NumberReportQueryService {
    private final List<NumberReportGenerator> reportGenerators;
    ...
    public QNumberReport fetchNumberReport(NumberReportQuery queryCommand, User user) {
        ...
        NumberReportGenerator generator = getReportGenerator(report);
        Double result = generator.generate(report, groupIds, app);
    ...
    private NumberReportGenerator getReportGenerator(NumberReport report) {
