...
public class ControlDoughnutReportGenerator implements ChartReportGenerator {
    ...
    public boolean supports(ChartReport report) {
        return report instanceof ControlDoughnutReport;
    }

    @Override
    public QChartReport generate(ChartReport report, Set<String> groupIds, App app) {
        ControlDoughnutReport theReport = (ControlDoughnutReport) report;
